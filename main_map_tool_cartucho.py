...
map_tool_dir='/home/prdcv/PycharmProjects/gvh205/mAP/'
image_dir='/home/prdcv/Desktop/darknet/test_voc_2007/VOCdevkit/VOC2007/JPEGImages/'
predict_dir='/home/prdcv/PycharmProjects/gvh205/mAP tools/Cartucho/output_original/'
groundtruth_dir='/home/prdcv/Desktop/darknet/test_voc_2007/VOCdevkit/VOC2007/Annotations/'
...
"""
tmp_files_path = map_tool_dir+'tmp_files'
if not os.path.exists(tmp_files_path): # if it doesn't exist already
  os.makedirs(tmp_files_path)
results_files_path = map_tool_dir+'results'
...
ground_truth_files_list = glob.glob(groundtruth_dir+'*.txt')
...
for txt_file in ground_truth_files_list:
  ...
  if not os.path.exists(predict_dir + file_id + ".txt"):
    error_msg = "Error. File not found:" +  file_id + ".txt\n"
...
for class_index, class_name in enumerate(gt_classes):
  ...
  for txt_file in predicted_files_list:
    ...
    file_id = os.path.basename(os.path.normpath(file_id))
    if class_index == 0:
      if not os.path.exists(groundtruth_dir + file_id + ".txt"):
        error_msg = "Error. File not found: " +  file_id + ".txt\n"
        error_msg += "(You can avoid this error message by running extra/intersect-gt-and-pred.py)"
        error(error_msg)
